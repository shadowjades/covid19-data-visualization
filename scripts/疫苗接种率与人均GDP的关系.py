...
# 调整动画速度
fig.layout.updatemenus[0].buttons[0].args[1]['frame']['duration'] = 50  # 将每帧的持续时间设置为500ms
fig.layout.updatemenus[0].buttons[0].args[1]['transition']['duration'] = 10  # 将过渡持续时间设置为300ms
